...
import { createDate, deleteDate, fetchAdminDates, updateDate } from "@/lib/api";
...
function AdminDashboard() {
	...
	function handleEdit(date: ArrivalDate) {
		setFormData({
			departureDate: date.departureDate || date.date,
			date: date.date,
					...
					<div className="lg:col-span-2">
						<Card className="border-0 shadow-sm">
							<CardHeader className="flex flex-row items-center justify-between">
								<CardTitle>Fechas de Vuelo</CardTitle>
								<Button
									size="sm"
									onClick={() => {
										resetForm();
							...
							<CardContent>
								...
								{dates.length === 0 ? (
									<div className="text-center py-12 text-muted-foreground">
										...
										<p className="text-sm">
											Agrega la primera salida y llegada
										</p>
									</div>
								) : (
												...
												>
													<div className="flex items-center gap-4">
														...
														<div>
															...
															<p className="text-sm text-muted-foreground">
																Salida:{" "}
																{formatDate(date.departureDate || date.date)}
															</p>
															<p className="text-sm text-muted-foreground">
																Llegada: {formatDate(date.date)}
															</p>
															{date.notes && (
										...
										<div>
											...
											<Select
												...
												onChange={(e) =>
													setFormData({
														...formData,
														status: e.target.value as ArrivalDateStatus,
													})
												}
											>
							...
							<Card className="border-0 shadow-sm">
								<CardContent className="p-6 text-center">
									...
									<p className="text-muted-foreground mb-4">
										Agrega una nueva salida y llegada
									</p>
